...
class Config(object):
    def __init__(self, min_period, max_period, stalta_waterlevel=0.01,
                 tshift_acceptance_level=0.1, tshift_reference=0.0,
                 dlna_acceptance_level=1.3, dlna_reference=0.0,
                 cc_acceptance_level=0.0, s2n_limit=1.5, earth_model="ak135",
                 min_surface_wave_velocity=0.05,
                 max_time_before_first_arrival=0.05,
                 c_0=1.0, c_1=1.5, c_2=0.0,
                 c_3a=4.0, c_3b=2.5, c_4a=2.0, c_4b=6.0,
                 check_global_data_quality=False, snr_integrate_base=3.5,
                 snr_max_base=3.0, noise_start_index=0, noise_end_index=6,#noise_end_index=None,
                 signal_start_index=None, signal_end_index=-1,
                 window_weight_fct=None,   #window_weight_fct=None,xichengpeng修改
