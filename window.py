...
#        print('##############left#############',left)
        ...
        self.max_cc_value = 0.8   #self.max_cc_value = None,xichengpeng修改
        self.cc_shift = 0.5     #   self.cc_shift = None,xichengpeng 修改
        self.dlnA = 0.5        #    self.dlnA = None ，xichengpeng 修改
        self.dt = float(dt)
...
#        print('new_win',new_win)
#        print('left=win["left_index"]',left=win["left_index"])
#        return new_win
#        print('len(new_win)',len(new_win))
